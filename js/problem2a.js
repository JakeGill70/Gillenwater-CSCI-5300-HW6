...
var problem2a = { 
    ...
    _getLucasNumber : function(index){
        ...
        if(index == 0){
            ...
            let gln1 = _getLucasNumber(index-1); // Get the previous number in the lucas series
            let gln2 = _getLucasNumber(index-2); // Get the previous previous number in the lucas series
