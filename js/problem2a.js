...
var problem2a = { 
    ...
    getLucasNumber : function(index, maxTime){
        ...
        return problem2a._getLucasNumber(index);
    },
    ...
    _getLucasNumber : function(index){
        ...
        if(index == 0){
            ...
            let gln1 = problem2a._getLucasNumber(index-1); // Get the previous number in the lucas series
            let gln2 = problem2a._getLucasNumber(index-2); // Get the previous previous number in the lucas series
